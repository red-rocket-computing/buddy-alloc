...
all: ${SUBDIRS} $(addprefix ${CURDIR}/,${TARGET}) $(addprefix ${CURDIR}/,${EXEC})

clean: ${SUBDIRS}
	@echo "CLEANING ${TARGET}"
	$(Q)${RM} ${TARGET} $(basename ${TARGET}).img $(basename ${TARGET}).bin $(basename ${TARGET}).elf $(basename ${TARGET}).map $(basename ${TARGET}).smap ${OBJ} ${OBJ:%.o=%.d} ${OBJ:%.o=%.dis}
...
${CURDIR}/${EXEC}: ${OBJ} ${EXTRA_DEPS}
	@echo "LINKING $@"
	$(Q)$(CC) ${LDFLAGS} ${LOADLIBES} -o $@ ${OBJ} ${LDLIBS}
